...
export class PriAdministrativeDecision{
  ...
  */
  static getTableFields() {
    return {
      administrativeDecisionId: { header: 'ID', type: 'number', sortable: true, filterable: false, width: 'w-16' },
      administrativeDecisionNumber: { header: 'Шийдвэрийн дугаар', type: 'string', sortable: true, filterable: true, width: 'w-48' },
      decisionDate: { header: 'Шийдвэрийн огноо', type: 'date', sortable: true, filterable: true, width: 'w-48' },
      'decisionType.name': { header: 'Шийдвэрийн төрөл', type: 'ref', sortable: false, filterable: true, width: 'w-16' },
      'department.name': { header: 'Алба хэлтэс', type: 'ref', sortable: false, filterable: true, width: 'w-16' },
      'employee.person.firstName': { header: 'Албан хаагч', type: 'ref', sortable: false, filterable: true, width: 'w-16' },
      createdDate: { header: 'Үүсгэсэн огноо', type: 'date', sortable: true, filterable: false, width: 'w-16' },
    };
  }
}