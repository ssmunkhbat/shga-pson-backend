...
export class PriOffenceActionView {
  ...
  static getTableFields() {
    return {
      ...
      decisionDate: { header: 'Ирсэн огноо', type: 'date', sortable: true, filterable: true, width: 'w-48' },
      wfmStatus: {
        header: 'Төлөв',
        type: 'refstatus',
      ...
      updatedDate: { header: 'Засварлсан огноо', type: 'datetime', sortable: true, filterable: true, width: 'w-48' },
      updatedEmployeeName: { header: 'Засварлсан ажилтан', type: 'string', sortable: true, filterable: true, width: 'w-48' },
