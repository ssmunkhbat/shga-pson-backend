  ...
  */
  static getTableFields() {
    return {
      ...
      lastName: { header: 'Эцэг/Эх-ийн нэр', type: 'string', sortable: false, filterable: true, width: 'w-24' },
      firstName: { header: 'Өөрийн нэр', type: 'string', sortable: false, filterable: true, width: 'w-24' },
      nickname: { header: 'Хоч', type: 'string', sortable: false, filterable: true, width: 'w-24' },
      departmentName: { header: 'Хорих анги, Байгууллага', type: 'string', sortable: false, filterable: true, width: 'w-24' },
      lastActCode: { header: 'Зүйл анги', type: 'string', sortable: false, filterable: true, width: 'w-24' },
      beginDate: { header: 'Эхлэх огноо', type: 'date', sortable: false, filterable: true, width: 'w-24' },
      statusName: { header: 'Төлөв', type: 'string', sortable: false, filterable: true, width: 'w-12' },
      sentenceCnt: { header: 'Удаа дараа', type: 'string', sortable: false, filterable: true, width: 'w-12' },
      regimeName: { header: 'Дэглэм', type: 'string', sortable: false, filterable: true, width: 'w-12' },
      regimeClassName: { header: 'Зэрэглэл', type: 'string', sortable: false, filterable: true, width: 'w-12' },
    };
  }
}