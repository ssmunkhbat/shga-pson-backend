...
@ViewEntity({
  expression: `SELECT * FROM "KHORIGDOL_VT"."PRI_MOVEMENT_DEPARTURE_PACK_VW"`,
  name: 'PRI_MOVEMENT_DEPARTURE_PACK_VW',
  schema: 'KHORIGDOL_VT',
})
export class MovementDeparture {
  ...
  static getTableFields() {
    return {
      ...
      createdDate: { header: 'Үүсгэсэн огноо', type: 'date', sortable: true, filterable: true, width: 'w-60' },
